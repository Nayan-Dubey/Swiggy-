      ...
      <div className="w-3/5 h-auto p-10 bg-white my-5">
        <div className="sec-1 flex">
          <div className="">
            ...
            <p className="my-3">
              Welcome to Swiggy! We are passionate about connecting food
        ...
        <div className="section-2 my-10">
          <div>
            ...
            <p className="m-5">
              Swiggy was founded with the vision of revolutionizing the way
        ...
        <div className="m-5 bg-red-900 text-white text-center">Created by <a className="font-medium underline" href="https://www.linkedin.com/in/nayan-dubey/">Nayan Dubey</a></div>
